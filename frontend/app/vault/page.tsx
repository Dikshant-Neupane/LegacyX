...
export default function YourVaultPage() {
    ...
    // No vault — redirect to create page (or show error if backend issue)
    if (!hasVault) {
        if (error) {
            return (
                <div className="min-h-screen pt-24 pb-16 px-6 flex flex-col items-center justify-center">
                    <div className="vault-card p-12 text-center max-w-md">
                        ...
                        <p className="text-vault-red text-sm mb-6">
                            {error}
                        </p>
                        <button
                            onClick={refresh}
        ...
        // No error, just no vault — redirect to create
            ...
            <div className="max-w-7xl mx-auto">
                ...
                >
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <span
                            className={`text-[10px] uppercase tracking-wider px-2 py-0.5 rounded ${vault!.status === 'Active'
                    ...
                    >
                        ...
                        <div className="vault-card p-8 flex flex-col items-center">
                            ...
                            <motion.button
                                ...
                                className={`mt-8 w-full py-4 rounded-lg font-body text-sm uppercase tracking-widest transition-all duration-300 ${checkInSuccess
                            ...
                            <div className="p-4 space-y-3">
                                {notifications.length > 0 ? (
                                    notifications.slice(0, 10).map((n, i) => (
                                        ...
                                        >
                                            <div
                                                className={`w-2 h-2 rounded-full ${n.type === 'check_in_reminder'
                                                    ? 'bg-vault-amber'
